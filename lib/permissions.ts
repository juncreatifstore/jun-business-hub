...
const READ_ALL: PermissionCode[] = [
  ...
  "PAYMENT_READ", "REFUND_READ", "EXPENSE_READ", "EMAIL_READ",
];
...
export const ROLE_PERMISSIONS: Record<StaffRole, PermissionCode[]> = {
  ...
  FINANCE: [
    ...
    "EXPENSE_CREATE", "EXPENSE_APPROVE", "FILE_UPLOAD", "DOCUMENT_CREATE", "AI_USE",
  ],
  TRAVEL_AGENT: [
    ...READ_ALL,
    "CLIENT_CREATE", "CLIENT_UPDATE", "CASE_CREATE", "CASE_UPDATE",
  ...
  ACCOUNTANT: [...READ_ALL, "PAYMENT_CREATE", "EXPENSE_CREATE", "FILE_UPLOAD", "AI_USE"],
