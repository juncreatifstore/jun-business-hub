...
const READ_ALL: PermissionCode[] = [
  ...
  "PAYMENT_READ", "REFUND_READ", "EXPENSE_READ", "INVOICE_READ", "ACCOUNTING_READ", "BUDGET_READ", "EMAIL_READ",
];
...
export const ROLE_PERMISSIONS: Record<StaffRole, PermissionCode[]> = {
  ...
  MANAGER: [
    ...
    "CLIENT_CREATE", "CLIENT_UPDATE", "CASE_CREATE", "CASE_UPDATE", "CASE_ADMIN",
    "TASK_CREATE", "TASK_UPDATE", "DOCUMENT_CREATE", "DOCUMENT_EDIT",
    "FILE_UPLOAD", "PAYMENT_CREATE", "REFUND_CREATE", "EXPENSE_CREATE", "INVOICE_CREATE", "BUDGET_CREATE", "EMAIL_DRAFT", "EMAIL_ACCOUNT_ACCESS", "AI_USE", "AI_APPROVE",
  ],
  FINANCE: [
    ...
    "EXPENSE_CREATE", "EXPENSE_APPROVE", "INVOICE_CREATE", "INVOICE_APPROVE", "ACCOUNTING_POST", "ACCOUNTING_CLOSE",
    "BUDGET_CREATE", "BUDGET_APPROVE", "FILE_UPLOAD", "DOCUMENT_CREATE", "AI_USE",
  ],
  TRAVEL_AGENT: [
    ...READ_ALL,
    "CLIENT_CREATE", "CLIENT_UPDATE", "CASE_CREATE", "CASE_UPDATE",
    "TASK_CREATE", "TASK_UPDATE", "FILE_UPLOAD", "DOCUMENT_CREATE", "INVOICE_CREATE", "EMAIL_DRAFT", "AI_USE",
  ],
  DOCUMENT_AGENT: [
    ...READ_ALL,
  ...
  ACCOUNTANT: [...READ_ALL, "BANK_RECON_READ", "BANK_RECON_IMPORT", "BANK_RECON_APPROVE", "BANK_RECON_CLOSE", "PAYMENT_CREATE", "EXPENSE_CREATE", "INVOICE_CREATE", "INVOICE_APPROVE", "ACCOUNTING_POST", "ACCOUNTING_CLOSE", "BUDGET_CREATE", "FILE_UPLOAD", "AI_USE"],
