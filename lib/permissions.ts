...
const READ_ALL: PermissionCode[] = [
  ...
  "PAYMENT_READ", "REFUND_READ", "EXPENSE_READ", "ACCOUNTING_READ", "BUDGET_READ", "EMAIL_READ",
];
...
export const ROLE_PERMISSIONS: Record<StaffRole, PermissionCode[]> = {
  ...
  MANAGER: [
    ...
    "FILE_UPLOAD", "PAYMENT_CREATE", "REFUND_CREATE", "EXPENSE_CREATE", "BUDGET_CREATE", "EMAIL_DRAFT", "AI_USE", "AI_APPROVE",
  ],
  FINANCE: [
  ...
  ACCOUNTANT: [...READ_ALL, "BANK_RECON_READ", "BANK_RECON_IMPORT", "BANK_RECON_APPROVE", "BANK_RECON_CLOSE", "PAYMENT_CREATE", "EXPENSE_CREATE", "ACCOUNTING_POST", "ACCOUNTING_CLOSE", "BUDGET_CREATE", "FILE_UPLOAD", "AI_USE"],
