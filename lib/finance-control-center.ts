...
export async function getFinanceControlCenter(){
  ...
  const [payments,refunds,accounts,onlineSessions,manualOrders,expenses,budgetPlans]=await Promise.all([
    ...
    getFinancePaymentAccounts(), listOnlinePaymentSessions(300), getManualTransferOrders(), listFinanceExpenses(500), listBudgetPlans(100)
  ]);
