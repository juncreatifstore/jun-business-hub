...
export default function Loading() {
  return (
    <div className="space-y-5" aria-label="Chargement">
      <div className="rounded-2xl border border-white/[0.06] bg-white/[0.018] p-5 sm:p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {Array.from({ length: 4 }).map((_, index) => (
          <div key={index} className="rounded-2xl border border-white/[0.06] bg-white/[0.018] p-4">
