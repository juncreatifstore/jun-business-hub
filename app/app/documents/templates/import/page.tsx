  ...
  return (
    <div className="max-w-3xl">
      <Link
        ...
        className="mb-4 inline-flex items-center gap-2 text-sm font-medium text-muted2 hover:text-electric"
      >
      ...
      <p className="mt-1 text-sm text-muted2">
        Import a numbered Markdown/text catalog into JUN as inactive reference entries.
      </p>
      ...
      <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-5 text-sm text-amber-900">
        <div className="flex gap-3">
          ...
          <div>
            <p className="font-semibold">Reference entries are not ready-to-use legal documents.</p>
            <p className="mt-1">
              JUN imports the title, category and reference number only. Each entry stays inactive until
              someone converts it to an editable template, writes/reviews the content and explicitly activates
              it.
            </p>
          </div>
        </div>
      ...
      <form
        action={importAdministrativeTemplateCatalog}
        className="mt-5 rounded-xl border border-line bg-white p-6"
      >
        <label htmlFor="catalog" className="block text-sm font-medium">
        ...
        <p className="mt-2 text-xs text-muted2">
          Expected format: section headings beginning with “## 1.” through “## 14.” and numbered entries like
          “1. Fiche de poste”. Duplicate source references are skipped automatically.
        </p>
