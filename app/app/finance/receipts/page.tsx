          ...
          <tbody>
            {payments.map((p) => {
              ...
              return (
                <TR key={p.id}>
                  <TD>
                    <Link href={`/app/finance/receipts/${p.id}`} className="registry-id hover:text-electric">
                      {receiptReference}
                    </Link>
                    <div className="mt-0.5 text-[11px] text-muted2">{p.reference}</div>
                  </TD>
                  <TD>
                    <Link href={`/app/clients/${p.clientId}`} className="hover:text-electric">
                  ...
                  <TD>
                    <span
                      className={`rounded-full px-2 py-1 text-xs font-medium ${receiptStatus === "ACTIVE" ? "bg-emerald-50 text-emerald-700" : "bg-red-50 text-red-700"}`}
                    >
                      {receiptStatus}
                    </span>
                  </TD>
                  ...
                  <TD>
                    <Link href={`/app/finance/receipts/${p.id}`} className="text-electric hover:underline">
                      Open
                    </Link>
                  </TD>
                </TR>
