...
import { BarChart3, BookOpen, BrainCircuit, CreditCard, Gauge, Landmark, ReceiptText, Send, Undo2, WalletCards, CircleDollarSign, Scale, Target } from "lucide-react";
...
export default function FinanceLayout({ children }: { children: React.ReactNode }) {
  return <div data-finance-release="phase12-budgeting-2026-08-21">
