...
import { BarChart3, BookOpen, BrainCircuit, CreditCard, Gauge, Landmark, ReceiptText, Send, Undo2, WalletCards, CircleDollarSign, Scale } from "lucide-react";
...
const links = [
  ...
  { href: "/app/finance/reconciliation", label: "Reconciliation", icon: Scale },
...
export default function FinanceLayout({ children }: { children: React.ReactNode }) {
  return <div data-finance-release="phase11-bank-reconciliation-2026-08-21">
