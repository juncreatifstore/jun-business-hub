...
import { BarChart3, BrainCircuit, CreditCard, Gauge, Landmark, ReceiptText, Send, Undo2, WalletCards } from "lucide-react";
...
export default function FinanceLayout({ children }: { children: React.ReactNode }) {
  return <div data-finance-release="phase8-enterprise-ai-2026-08-21">
