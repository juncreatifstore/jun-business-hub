...
export default async function NewInvoicePage(props: { searchParams: Promise<{ toast_error?: string }> }) {
  ...
  return (
    <div>
      <PageHeader
        title="New invoice"
        subtitle="Create a professional client invoice and track it through Accounts Receivable."
      />
      ...
      <div className="mb-4">
        <Link href="/app/finance/invoices" className="text-sm text-electric hover:underline">
          ← Back to invoices
        </Link>
      </div>
