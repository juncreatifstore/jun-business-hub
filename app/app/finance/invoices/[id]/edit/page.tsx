...
export default async function EditInvoicePage({ params }: { params: { id: string } }) {
  ...
  return (
    <div>
      <PageHeader title={`Correct ${inv.invoiceNumber}`} subtitle={editPolicyMessage(mode)}>
        ...
        <Card>
          <CardContent className="p-5">
            <div className="rounded-xl border border-red-200 bg-red-50 p-4 text-sm text-red-800">
              This invoice has confirmed payments or is final. Do not overwrite it. Create a credit/corrective
              invoice instead.
            </div>
          </CardContent>
        </Card>
