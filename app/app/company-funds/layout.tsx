...
export default async function CompanyFundsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="space-y-5 pb-20 md:pb-0">
      <CompanyFundsNav workQueue={workQueue} />
      <CompanyFundsFilters countries={countries} currencies={currencies} />
      <CompanyFundsOverviewNavigator />
      <CompanyFundsPageMemory>{children}</CompanyFundsPageMemory>
      <CompanyFundsMobileNav workQueue={workQueue} />
    </div>
  );
}
