  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,300..800&family=Public+Sans:wght@300..800&family=IBM+Plex+Mono:wght@400;500&display=swap"
          rel="stylesheet"
        />
