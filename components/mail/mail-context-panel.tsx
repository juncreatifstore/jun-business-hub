...
import { updateMailClientCase, createTaskFromMail, logMailToCaseTimeline } from "@/services/mail-case-context";
...
export async function MailContextPanel({threadId}:{threadId:string}){
 ...
 const [clients,cases,linkedCase]=await Promise.all([
 ...
 const canTask=can(user,"TASK_CREATE"),canCaseUpdate=can(user,"CASE_UPDATE");
