  ...
  return (
    <>
      <header className="sticky top-0 z-30 flex h-[72px] items-center gap-2.5 border-b border-white/[0.06] bg-[#09111f]/92 px-3 text-white shadow-[0_8px_30px_rgba(0,0,0,.12)] backdrop-blur-xl sm:px-6">
        ...
        <button
          type="button"
          onClick={() => { setCommandOpen(true); setCreateOpen(false); setProfileOpen(false); }}
        ...
        >
          ...
          <span className="min-w-0 flex-1 truncate text-sm text-slate-600 group-hover:text-slate-400">Rechercher ou lancer une commande…</span>
