            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-2 flex min-w-0 flex-wrap items-center gap-x-3 gap-y-1.5 text-[11px] text-slate-500 sm:gap-x-4 sm:gap-y-2 sm:text-xs">
                <Link
                  ...
                  className="registry-id max-w-full break-all text-slate-300 hover:text-blue-300"
                >
                  {registryId}
                </Link>
                {client ? (
                  <Link
                    ...
                    className="inline-flex min-w-0 items-center gap-1.5 hover:text-blue-300"
                  >
              ...
              <div className="mt-4 grid gap-2 sm:grid-cols-[minmax(180px,260px)_auto] sm:items-center">
                <div>
                  <div className="mb-1.5 flex items-center justify-between gap-2 text-[9px] uppercase tracking-[0.12em] text-slate-600 sm:text-[10px] sm:tracking-[0.14em]">
                ...
                {currentSigner ? (
                  <div className="min-w-0 rounded-xl border border-white/[0.07] bg-white/[0.025] px-3 py-2 text-[11px] sm:text-xs">
                    <span className="text-slate-600">Signataire actuel</span>
                    <div className="mt-1 flex min-w-0 flex-wrap items-center gap-1.5 text-slate-200 sm:gap-2">
                      <Mail className="h-3.5 w-3.5 shrink-0 text-emerald-400" />
                      <strong className="truncate">{currentSigner.name}</strong>
                      <span className="max-w-full break-all text-slate-500">{currentSigner.email}</span>
                    </div>
                  </div>
                ) : null}
              </div>
